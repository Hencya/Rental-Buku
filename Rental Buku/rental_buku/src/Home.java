...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_formBuku = new usu.widget.ButtonGlass();
        ...
        btn_formUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Add.png"))); // NOI18N
        ...
        btn_transaksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Return Book.png"))); // NOI18N
        btn_transaksi.setText("Pengembalian Buku");
        ...
        btn_formPeminjam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Borrow Book.png"))); // NOI18N
        btn_formPeminjam.setText("Pinjam Buku");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Cover.png"))); // NOI18N
        jLabel3.setText("jLabel3");
        jDesktopPane1.add(jLabel3);
        jLabel3.setBounds(0, 0, 1220, 790);
        jDesktopPane1.add(jTabbedPane1);
        jTabbedPane1.setBounds(360, 520, 21, 21);

        getContentPane().add(jDesktopPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, 1220, 790));

        btn_formBuku.setForeground(new java.awt.Color(255, 255, 255));
        btn_formBuku.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Add Book.png"))); // NOI18N
        btn_formBuku.setText("Tambahkan Buku");
        btn_formBuku.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btn_formBuku.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_formBukuActionPerformed(evt);
            }
        });
        getContentPane().add(btn_formBuku, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 210, 80));

        btn_login.setForeground(new java.awt.Color(255, 255, 255));
        btn_login.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Login big.png"))); // NOI18N
        ...
        btn_log_Off.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Logout big.png"))); // NOI18N
        ...
        btn_closee.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Exit big.png"))); // NOI18N
        ...
        btn_closee1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Kelompok.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Home 1.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 790));
    ...
    private void btn_formBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_formBukuActionPerformed
        jDesktopPane1.removeAll();
        jDesktopPane1.repaint();
        Form_buku fm = new Form_buku();
        fm.setVisible(true);
        jDesktopPane1.add(fm);        // TODO add your handling code here:
    }//GEN-LAST:event_btn_formBukuActionPerformed
    ...
    public static usu.widget.ButtonGlass btn_formBuku;
