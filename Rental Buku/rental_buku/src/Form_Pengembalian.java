...
public class Form_Pengembalian extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btn_Kembalikan_buku = new usu.widget.ButtonGlass();
        ...
        jLabel15.setText("Form Pengembalian Buku");
        ...
        btn_Kembalikan_buku.setForeground(new java.awt.Color(255, 255, 255));
        btn_Kembalikan_buku.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Return Book.png"))); // NOI18N
        btn_Kembalikan_buku.setText("Kembalikan Buku");
        btn_Kembalikan_buku.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_Kembalikan_bukuActionPerformed(evt);
            }
        });
        panelGlass2.add(btn_Kembalikan_buku, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, 220, 110));
        ...
        panelGlass2.add(boxcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 112, -1));

        jLabel9.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Kode Buku");
        panelGlass2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 90, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Cover 2.png"))); // NOI18N
    ...
    private void boxcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxcodeActionPerformed
        ...
        ResultSet rst = con.querySelectAll("tb_transaksi", "code='" + st + "'");
        try {
            while (rst.next()) {
    ...
    private void btn_Kembalikan_bukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Kembalikan_bukuActionPerformed
   ...
   }//GEN-LAST:event_btn_Kembalikan_bukuActionPerformed
    ...
    private usu.widget.ButtonGlass btn_Kembalikan_buku;
    ...
    public void hapus_transaksi() {
        if (JOptionPane.showConfirmDialog(this, "Yakin Mengembalikan Buku ?", "Peringatan", JOptionPane.OK_CANCEL_OPTION) == JOptionPane.OK_OPTION) {
            con.queryDelete("tb_transaksi", "code='" + boxcode.getSelectedItem().toString() + "'");
        }

    }

    private void loadTabel() {
        String namaKolom[] = {"id_transaksi", "peminjam", "code", "tgl_pinjaman", "tgl_kembali", "harga", "lama", "total"}; //,
