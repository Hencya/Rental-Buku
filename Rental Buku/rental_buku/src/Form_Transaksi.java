...
public class Form_Transaksi extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        boxcode = new javax.swing.JComboBox();
        ...
        lbl_alamat.setText("Alamat");
        panelGlass1.add(lbl_alamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 110, 47));
        ...
        btn_Refresh__addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Calculator_1.png"))); // NOI18N
        ...
        lbl_judul.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lbl_judul.setForeground(new java.awt.Color(255, 255, 255));
        lbl_judul.setText("lbl_judul");

        lbl_pengarang.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        lbl_pengarang.setForeground(new java.awt.Color(255, 255, 255));
        lbl_pengarang.setText("lbl_pengarang");
                        ...
                        .addGroup(panelGlass2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelGlass2Layout.createSequentialGroup()
                                ...
                                .addGroup(panelGlass2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbl_judul, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lbl_tahun, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lbl_pengarang, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(189, 189, 189))
                            .addGroup(panelGlass2Layout.createSequentialGroup()
        ...
        table_transaksi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama  Peminjam", "Code", "Harga", "Tgl Pinjam", "Tgl Kembali", "Lama Pinjam", "Total"
            }
        ) {
        ...
        btn_Refresh__addItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Refresh_1.png"))); // NOI18N
        ...
        btn_create_addItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Borrow Book.png"))); // NOI18N
        ...
        jLabel6.setText("Form Transaksi Buku");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Cover 2.png"))); // NOI18N
    ...
    private void boxcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxcodeActionPerformed
        ...
        String st = (String) boxcode.getSelectedItem();
        ResultSet rst = con.querySelectAll("tb_buku", "code='" + st + "'");
        try {
            while (rst.next()) {

                this.lbl_judul.setText(rst.getString("judul"));
                this.lbl_pengarang.setText(rst.getString("pengarang"));
                this.lbl_tahun.setText(rst.getString("tahun_terbit"));
    ...
    private javax.swing.JComboBox boxcode;
    ...
    private void loadBuku() {  // mengambil database

        rs = con.querySelectAll("tb_buku");
        try {
            while (rs.next()) {
                boxcode.addItem(rs.getString("code"));
            }
    ...
    private void loadTabel() {
        String namaKolom[] = {"id_transaksi", "peminjam","code", "harga", "tgl_pinjaman", "tgl_kembali", "lama", "total"}; //,
        ...
        try {
            ...
            if (!lblNama.getText().isEmpty()) {
                ...
                if (!jikakeluar()) {
                    ...
                    JOptionPane.showMessageDialog(this, "maaf buku ini sedang tidak tersedia");
                } else {
                    String kolom[] = {"peminjam", "code", "tgl_pinjaman", "tgl_kembali", "harga", "lama", "total"};
                    ...
                    String isi[] = {lblNama.getText(), boxcode.getSelectedItem().toString(), new java.sql.Date(tgl.getTime()).toString(), new java.sql.Date(tgl1.getTime()).toString(), lbl_harga.getText(), txt_lama.getText(), txt_total.getText()};
    ...
    public void cekstatus() throws SQLException {
        rs = con.querySelectAll("tb_buku", "code ='" + boxcode.getSelectedItem().toString() + "'");
        while (rs.next()) {
        ...
        con.queryUpdate("tb_buku", kolom, isi, "code='" + boxcode.getSelectedItem().toString() + "'");
